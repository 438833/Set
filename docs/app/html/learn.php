...
<ul>
    ...
    <li>Если ваша функция промежуточного программного обеспечения возвращает false, все выполнение останавливается, и генерируется ошибка 403 Forbidden. Вероятно, вам захочется более грациозно обработать это с помощью <code>Set::redirect()</code> или чего-то подобного.</li>
